...
test.cb("Can map", (tst) => {
    ...
    let data = [
        '["ef2",1,58,"1_1","2017-06-24T10:46:12.432Z","error_command","g"]',
        '["8cf",1,29,"2_3","2017-06-25T14:47:13.856Z","hello_command","g"]',
        '["def",1,1816,"1_1","2017-06-19T06:20:05.168Z","my-projects/getTLIdEncoderDecoder.md","g"]'
    ].join("\n");
    ...
    localCommitFileToCommitMapFunc(input, (err, c: Commit) => {
        let backupRecords: BackupRecord[] = [
                { gpgKey: 'g', sha256: 'ef2', operation: Operation.Create, fileByteCount: 58, modifiedDate: new Date('2017-06-24T10:46:12.432Z'), path: 'error_command', part: [1, 1] },
                { gpgKey: 'g', sha256: '8cf', operation: Operation.Create, fileByteCount: 29, modifiedDate: new Date('2017-06-25T14:47:13.856Z'), path: 'hello_command', part: [2, 3] },
                { gpgKey: 'g', sha256: 'def', operation: Operation.Create, fileByteCount: 1816, modifiedDate: new Date('2017-06-19T06:20:05.168Z'), path: 'my-projects/getTLIdEncoderDecoder.md', part: [1, 1] }
            ],
            expected: Commit = {
                gpgKey: 'gpg-key',
