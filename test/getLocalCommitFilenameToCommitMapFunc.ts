...
test.cb("Can map", (tst) => {
    ...
    localCommitFileToCommitMapFunc(input, (err, c: Commit) => {
        let backupRecords: BackupRecord[] = [
                ...
                { filePartByteCountThreshold: 1024, gpgKey: 'g', sha256: '8cf', operation: Operation.Create, fileByteCount: 29, modifiedDate: new Date('2017-06-25T14:47:13.856Z'), path: 'hello_command', part: [2, 3] },
