...
export declare function push(rootDir: AbsoluteDirectoryPath, configDir: AbsoluteDirectoryPath, {quiet}: {
    quiet: any;
}): void;
export declare function listUpload(rootDir: AbsoluteDirectoryPath, configDir: AbsoluteDirectoryPath): void;
export declare function upload(rootDir: AbsoluteDirectoryPath, configDir: AbsoluteDirectoryPath, {quiet}: {
    quiet: any;
}): void;
export declare function fetch(rootDir: AbsoluteDirectoryPath, configDir: AbsoluteDirectoryPath, {quiet}: {
    quiet: any;
}): void;
